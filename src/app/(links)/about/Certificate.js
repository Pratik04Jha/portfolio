...
const Certificate = ({ data }) => {
  return (
    <div className="group h-110 w-100 border border-zinc-700 dark:border-zinc-700 rounded-xl overflow-hidden cursor-pointer flex flex-col transition-all duration-300   dark:hover:shadow-zinc-800 my-2 ">
